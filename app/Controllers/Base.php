...
class Base extends BaseController
{
    ...
    public function fiscal()
    {
        ...
        public function crop($img, $childFolderPath, &$allResults)
        {
            ...
            'Data' => ['x' => 637, 'y' => 142, 'width' => 136, 'height' => 77],
      ...
      public function xmlConstruct($allResults, $motherFolderName)
        ...
        foreach ($allResults as $singleFileResults) {
          ...
          $dataHoraEmissao = rtrim($dataHoraEmissao, ',');
          if ($dataHoraEmissao) {
            $dateObj = \DateTime::createFromFormat('d/n/Y', $dataHoraEmissao);  // Note o \ antes de DateTime
            if ($dateObj) {
